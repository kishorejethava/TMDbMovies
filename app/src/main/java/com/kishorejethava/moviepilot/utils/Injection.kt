...
import com.kishorejethava.moviepilot.movies.viewmodel.ViewModelFactory
...
object Injection {
     ...
     * [GithubLocalCache]
     */
    private fun provideMovieRepository(): MoviesRepository {
        return MoviesRepository(ApiService.create())
    }
